...
| 序号 | 图表 | 建议截图名 | 可直接复制的测试话术 |
|---:|---|---|---|
| 1 | 环形图 | `img.png` | 查询2026年3月1日至3月31日的售后工单，按处理状态统计工单数量，并使用环形图展示各状态占比。 |
| 2 | 条形图 | `01-bar.png` | 查询2026年3月1日至3月31日的销售订单，按产品汇总销售数量，并使用条形图展示各产品销量。 |
| 3 | 瀑布图 | `02-waterfall.png` | 查询委外订单OO20260301的来料、回货和退料记录，按产品展示数量变化，并使用瀑布图展示。 |
| 4 | 子弹图 | `03-bullet.png` | 查询采购订单PO20260302的收货情况，使用子弹图对比温度传感器NTC10K的订购数量和已收数量。 |
| 5 | 面积图 | `04-area.png` | 查询2026年3月1日至3月31日的销售订单，按订单日期展示销售金额变化，并使用面积图展示销售金额趋势。 |
| 6 | 阶梯图 | `05-step.png` | 查询2026年3月1日至3月31日的出入库记录，按日期展示出入库数量变化，并使用阶梯图展示。 |
| 7 | 雷达图 | `06-radar.png` | 查询批次L20260309的质检结果，使用雷达图对比抽样数量、合格数量和不良数量。 |
| 8 | 散点图 | `07-scatter.png` | 查询2026年3月1日至3月31日的销售订单，使用散点图分析订单销售数量与销售金额之间的关系。 |
| 9 | 气泡图 | `08-bubble.png` | 查询2026年3月1日至3月31日的质检记录，使用气泡图展示合格数量与不良数量的关系，并用抽样数量表示气泡大小。 |
| 10 | 直方图 | `09-histogram.png` | 查询2026年3月1日至3月31日的销售订单，使用直方图展示订单销售金额的分布情况。 |
| 11 | 箱线图 | `10-boxplot.png` | 查询2026年3月1日至3月31日的销售订单，按客户使用箱线图展示订单金额分布。 |
| 12 | 热力图 | `11-heatmap.png` | 查询2026年3月1日至3月31日的销售订单，使用热力图展示不同客户、不同产品对应的销售数量。 |
| 13 | 甘特图 | `06-gantt.png` | 查询2026年3月1日至3月31日开始的生产工单，使用甘特图展示各产品生产工单的计划开始日期和计划结束日期。 |
| 14 | 漏斗图 | `13-funnel.png` | 查询2026年3月1日至3月31日的售后工单，按处理状态统计数量，并使用漏斗图展示售后工单处理状态分布。 |
| 15 | 词云图 | `14-word-cloud.png` | 查询2026年3月1日至3月31日的售后工单，按问题类型统计出现次数，并使用词云图展示问题类型频次。 |
| 16 | 仪表盘图 | `15-gauge.png` | 查询张三电子科技有限公司的应收账款，使用仪表盘图展示当前未收账款余额。 |
| 17 | 水位图 | `16-liquid-fill.png` | 查询2026年3月1日至3月31日的销售汇总，使用水位图展示客户数量。 |
| 18 | 平行坐标图 | `17-parallel.png` | 查询2026年3月1日至3月31日开始的生产工单，使用平行坐标图对比各产品工单的计划数量、完成数量和报废数量。 |
| 19 | 折线图 | `18-line.png` | 查询2026年3月1日至3月31日的收款记录，按收款日期使用折线图展示收款金额变化趋势。 |
| 20 | 饼图 | `19-pie.png` | 查询2026年3月1日至3月31日的销售订单，按产品汇总销售数量，并使用饼图展示各产品销量占比。 |
